...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-black/20 text-black py-12 px-6 text-center">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Divider */}
        <div className="border-t border-black/20 pt-8 flex flex-col items-center justify-center gap-4">
